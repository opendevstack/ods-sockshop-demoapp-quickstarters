...
if (system.env.OPENSHIFT_APP_SERVICE === null || system.env.OPENSHIFT_APP_SERVICE === undefined) {
  appURL = "http://" + system.env.APP_NAME + "-" + system.env.OPENSHIFT_BUILD_NAMESPACE + "." + system.env.OPENSHIFT_HOST
} else {
  appURL = "http://" + system.env.OPENSHIFT_APP_SERVICE
}
