...
public class OrdersConfigurationProperties {
    ...
    public URI getPaymentUri() {
        return new ServiceUri(new Hostname("demo-app-payment"), new Domain(domain), "/paymentAuth").toUri();
    }

    public URI getShippingUri() {
        return new ServiceUri(new Hostname("demo-app-shipping"), new Domain(domain), "/shipping").toUri();
    }
